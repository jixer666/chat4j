package com.abc.chat4j.im.netty.websocket;

import com.abc.chat4j.im.netty.HttpHeadersHandler;
import com.abc.chat4j.im.netty.ImChannelHandler;
import com.abc.chat4j.im.netty.ImServer;
import com.abc.chat4j.im.netty.websocket.endecode.MessageProtocolDecoder;
import com.abc.chat4j.im.netty.websocket.endecode.MessageProtocolEncoder;
...
//                        pipeline.addLast(new HttpHeadersHandler()); // 处理请求头的参数
